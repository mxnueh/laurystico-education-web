...
export const courses: Course[] = [
  ...
  {
    slug: 'robotica-electronica-avanzada',
    title: 'Robótica Electrónica Avanzada',
    description: 'Diseña y construye robots con Arduino, sensores avanzados y programación en C++. Aprende electrónica aplicada y control de robots.',
    image: '/fotos/imagen robotica electronica.JPG',
    category: 'Electronica',
    level: 'Intermedio',
    durationHours: 20,
    durationLabel: '20 clases',
    tags: ['Arduino', 'C++', 'Sensores', 'Electrónica', 'Circuitos'],
    // price: 499, // Precio removido por solicitud del usuario
    rating: 4.9,
    studentsCount: 0,
    age: '12 en adelante',
    featured: true,
